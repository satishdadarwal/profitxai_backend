...
def _extract_stack(limit):
    ...
    while limit and frame is not None:
        ...
        older_Frame.f_code = Gevent_PyFrame_GetCode(
            frame
        )  # pylint:disable=undefined-variable
        older_Frame.f_lineno = Gevent_PyFrame_GetLineNumber(
            frame
        )  # pylint:disable=undefined-variable
...
class Greenlet(greenlet):
    ...
    def __init__(self, run=None, *args, **kwargs):
        ...
        if GEVENT_CONFIG.track_greenlet_tree:
            ...
            try:
                ...
                if (
                    get_generic_parent(spawner) is not None
                ):  # pylint:disable=undefined-variable
    ...
    def __start_pending(self):
        return self._start_event is not None and (
            self._start_event.pending or getattr(self._start_event, "active", False)
        )

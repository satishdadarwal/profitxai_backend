...
class AbstractCallbacks(object):
        ...
        try:
            ...
            if (
                ...
                try:
                    ...
                    print("WARNING: gevent: Error when handling error", file=sys.stderr)
                    traceback.print_exc()
    ...
    def unhandled_onerror(self, t, v, tb):
        ...
        print("WARNING: gevent: Unhandled error with no watcher", file=sys.stderr)
    ...
    def python_prepare_callback(self, watcher_ptr):
        ...
        if loop is None:  # pragma: no cover
            print(
                "WARNING: gevent: running prepare callbacks from a destroyed handle: ",
                watcher_ptr,
            )
            return
        loop._run_callbacks()
...
def assign_standard_callbacks(
    ffi, lib, callbacks_class, extras=()
...
class AbstractLoop(object):
    ...
    def _default_handle_error(
        self, context, type, value, tb
    ):  # pylint:disable=unused-argument
    ...
    def update(self):
        ...
        warnings.warn(
            "'update' is deprecated; use 'update_now'", DeprecationWarning, stacklevel=2
        )
        self.update_now()

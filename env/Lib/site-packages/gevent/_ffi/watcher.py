...
class AbstractWatcherType(type):
    ...
    def _fill_watcher(cls, name, bases, cls_dict):
        ...
        _watcher_prefix = cls_dict.get("_watcher_prefix") or _mro_get(
            "_watcher_prefix", bases
        )
        ...
        if not watcher_struct_name:
            watcher_struct_pattern = (
                cls_dict.get("_watcher_struct_pattern")
        ...
        callback_name = (
            cls_dict.get("_watcher_callback_name")
...
class watcher(metaclass=AbstractWatcherType):
    ...
    def _watcher_new(self):
        return type(self).new(
            self._watcher_struct_pointer_type
        ...
        def __del__(self):
            if self._watcher:
                ...
                if tb is not None:
                    ...
                    tb_msg = "\nTraceback:\n" + tb_msg
                warnings.warn(
                    "Failed to close watcher %r%s" % (self, tb_msg), ResourceWarning
                )
    ...
    def __repr__(self):
        ...
        try:
            ...
            if self.callback is not None:
                ...
                if fself is self:
                    result += " callback=<bound method %s of self>" % (
    ...
    def start(self, callback, *args):
        ...
        self._handle = self._watcher_set_data(
            self._watcher, type(self).new_handle(self)
        )  # pylint:disable=no-member
    ...
    def stop(self):
        ...
        self._handle = None
        self._watcher_set_data(
            self._watcher, self._FFI.NULL
        )  # pylint:disable=no-member
...
class IoMixin(object):
    ...
    def __init__(self, loop, fd, events, ref=True, priority=None, _args=None):
        ...
        super(IoMixin, self).__init__(
            loop, ref=ref, priority=priority, args=_args or (fd, events)
        )
...
class TimerMixin(object):
    ...
    def __init__(self, loop, after=0.0, repeat=0.0, ref=True, priority=None):
        ...
        super(TimerMixin, self).__init__(
            loop, ref=ref, priority=priority, args=(after, repeat)
        )
...
class SignalMixin(object):
    ...
    def __init__(self, loop, signalnum, ref=True, priority=None):
        ...
        super(SignalMixin, self).__init__(
            loop, ref=ref, priority=priority, args=(signalnum,)
        )
...
class StatMixin(object):
    ...
    def __init__(self, _loop, path, interval=0.0, ref=True, priority=None):
        ...
        super(StatMixin, self).__init__(
            _loop, ref=ref, priority=priority, args=(self._cpath, interval)
        )

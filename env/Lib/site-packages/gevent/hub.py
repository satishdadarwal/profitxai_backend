...
class signal(object):
    ...
    ref = property(
        lambda self: self.watcher.ref, lambda self, nv: setattr(self.watcher, "ref", nv)
    )
    ...
    def start_periodic_monitoring_thread(self):
        if self.periodic_monitoring_thread is None and GEVENT_CONFIG.monitor_thread:
            ...
            notify_and_call_entry_points(
                PeriodicMonitorThreadStartedEvent(self.periodic_monitoring_thread)
            )

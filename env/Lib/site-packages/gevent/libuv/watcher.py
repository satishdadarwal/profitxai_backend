...
_events = [(libuv.UV_READABLE, "READ"), (libuv.UV_WRITABLE, "WRITE")]
    ...
    def __getattr__(self, name):
        ...
        def wrap(*args, **kwargs):
            ...
            if res is not None and res < 0:
                ...
                raise kind(
                    str(
                        ffi.string(libuv.uv_err_name(res)).decode("ascii")
                        + " "
...
class watcher(_base.watcher):
    ...
    def _watcher_ffi_init(self, args):
        ...
        return self._watcher_init(self.loop.ptr, self._watcher, *args)
...
class io(_base.IoMixin, watcher):
    ...
    def __init__(self, loop, fd, events, ref=True, priority=None):
        super(io, self).__init__(
            loop, fd, events, ref=ref, priority=priority, _args=(fd,)
        )
        self._fd = fd
        self._events = events
    ...
    class _multiplexwatcher(object):
        ...
        fd = property(
            lambda self: getattr(self._watcher_ref, "_fd", -1),
...
class async_(_base.AsyncMixin, watcher):
    ...
    def _watcher_ffi_init(self, args):
        ...
        return self._watcher_init(self.loop.ptr, self._watcher, self._watcher_callback)
...
class signal(_base.SignalMixin, watcher):
    ...
    def _watcher_ffi_start(self):
        self._watcher_start(self._watcher, self._watcher_callback, self._signalnum)

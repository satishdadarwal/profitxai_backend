...
class StreamServer(BaseServer):
    ...
    **SSL Support**
    ...
    def __init__(
        self, listener, handle=None, backlog=None, spawn="default", **ssl_args
    ):
        ...
        try:
            ...
            if backlog is not None:
                if hasattr(self, "socket"):
                    raise TypeError(
                        "backlog must be None when a socket instance is passed"
                    )
    ...
    def get_listener(cls, address, backlog=None, family=None):
        ...
        return _tcp_listener(
            address, backlog=backlog, reuse_addr=cls.reuse_addr, family=family
        )

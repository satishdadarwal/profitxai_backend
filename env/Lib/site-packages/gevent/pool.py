...
class GroupMappingMixin(object):
    ...
    def __map(self, func, iterable):
        return [g.get() for g in [self.spawn(func, i) for i in iterable]]
    ...
    def __imap(self, cls, func, *iterables, **kwargs):
        ...
        return cls.spawn(
            func, izip(*iterables), spawn=self.spawn, _zipped=True, maxsize=maxsize
        )
...
class Pool(Group):
    ...
    def add(
        self, greenlet, blocking=True, timeout=None

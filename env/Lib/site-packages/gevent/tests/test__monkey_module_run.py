...
class TestRun(greentest.TestCase):
    ...
    def _run_package(self, module):
        ...
        self.assertEqual(lines[1].strip(), "__main__")
    ...
    def test_issue_302(self):
        ...
        self.assertEqual(monkey_lines[0].strip(), "True")
        monkey_lines[1] = monkey_lines[1].replace("\\", "/")  # windows path
        self.assertTrue(
            monkey_lines[1].strip().endswith("monkey_package/issue302monkey.py")
        )
        self.assertEqual(monkey_lines[2].strip(), "True", monkey_lines)

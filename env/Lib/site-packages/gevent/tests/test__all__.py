            ...
            try:
                ...
                if cls.stdlib_all is None:
                    ...
                    cls.stdlib_all = [
                        ...
                        and not isinstance(
                            getattr(cls.stdlib_module, name), types.ModuleType
                        )
                    ]
    ...
    def test_implements_subset_of_stdlib_all(self):
        ...
        for name in tuple(self.__implements__ or ()) + tuple(self.__imports__):
            ...
            raise AssertionError(
                ...
                % (name, self.stdlib_module, self.stdlib_module)
            )
...
def _create_tests():
    for _, modname in modules.walk_modules(
        include_so=False, recursive=True, check_optional=False
    ):
        if modname.endswith(PLATFORM_SPECIFIC_SUFFIXES):
            continue
        ...
        cls = type(
            ...
            {"__module__": __name__, "modname": orig_modname},
        )

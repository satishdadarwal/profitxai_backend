...
class TestTCP(greentest.TestCase):
    ...
    def _test_sendall(
        self, data, match_data=None, client_method="sendall", **client_args
    ):
    ...
    def test_attributes(self):
        ...
        if hasattr(socket, "SOCK_NONBLOCK"):
            ...
            s.setblocking(0)
            std_socket = monkey.get_original("socket", "socket")(
    ...
    def test_connect_ex_nonblocking_bad_connection(self):
        ...
        try:
            s.setblocking(False)
            ret = s.connect_ex(
                (greentest.DEFAULT_LOCAL_HOST_ADDR, support.find_unused_port())
            )
    ...
    def test_refuses(self, **conn_args):
        ...
        with self.assertRaisesRegex(
            ...
            socket.create_connection(
                (greentest.DEFAULT_BIND_ADDR, connect_port), timeout=30, **conn_args
            )

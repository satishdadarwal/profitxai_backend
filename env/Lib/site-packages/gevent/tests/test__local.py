...
class TestGeventLocal(greentest.TestCase):
    ...
    def test_slot_and_type_attributes(self):
        ...
        a.__dict__["initialized"] = (
            42  # pylint:disable=unsupported-assignment-operation
        )
        self.assertEqual(a.initialized, 2)
    ...
    def test_copy(self):
        ...
        b.path = "321"
        self.assertNotEqual(
            a.path, b.path, "The values in the two objects must be different"
        )

        ...
        if _notify_will_subscribers:
            _notify_patch(
                events.GeventWillPatchModuleEvent(
                    target_module.__name__, source_module, target_module, items
                ),
                _warnings,
            )
    ...
    if _notify_did_subscribers:
        ...
        _notify_patch(
            events.GeventDidPatchModuleEvent(
                target_module.__name__, source_module, target_module
            )
        )
...
class _GeventDoPatchRequest(object):
    ...
    def __init__(self, target_module, source_module, items, patch_kwargs):

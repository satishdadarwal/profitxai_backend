...
class FyersServiceSync:
    ...
    def post_call(self, api: str, header: str, data=None) -> dict:
        ...
        try:
            ...
            self.api_logger.debug(
                {"URL": URL, "data": json.dumps(data), "message": self.error_resp}
            )
...
class FyersServiceAsync:
    ...
    async def post_async_call(self, api: str, header: str, data=None) -> dict:
        ...
        try:
            ...
            self.api_logger.error({"API": api, "error": e})
            self.api_logger.debug(
                {"URL": url, "Post Data": json.dumps(data), "message": self.error_resp}
            )
            return self.error_resp
            ...
            self.api_logger.error({"API": api, "error": e})
            self.api_logger.debug(
                {"URL": url, "Post Data": json.dumps(data), "message": e}
            )
            return self.error_resp
...
class FyersModel:
    ...
    def cancel_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.delete_async_call(
                Config.orders_endpoint, self.header, data
            )
    ...
    def cancel_gtt_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.delete_async_call(
                Config.gtt_orders_sync, self.header, data
            )
        else:
            response = self.service.delete_call(
                Config.gtt_orders_sync, self.header, data
    ...
    def exit_positions(self, data={}) -> dict:
        ...
        if self.is_async:
            response = self.service.delete_async_call(
                Config.positions, self.header, data
            )
    ...
    def place_multileg_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.multileg_orders, self.header, data
            )
        else:
    ...
    def cancel_basket_orders(self, data):
        ...
        if self.is_async:
            ...
            response = self.service.delete_call(Config.multi_orders, self.header, data)
        return response
    ...
    def place_basket_orders(self, data):
        ...
        if self.is_async:
            ...
            response = self.service.post_call(Config.multi_orders, self.header, data)
        return response
    ...
    def modify_basket_orders(self, data):
        ...
        if self.is_async:
            ...
            response = self.service.patch_call(Config.multi_orders, self.header, data)
        return response
    ...
    def create_alert(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.price_alert, self.header, data
            )
        else:
    ...
    def update_alert(self, data) -> dict:
        ...
        """
        if self.is_async:
            response = self.service.put_async_call(
                Config.price_alert, self.header, data
            )
        else:
    ...
    def toggle_alert(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.put_async_call(
                Config.toggle_alert, self.header, data
            )
        else:
    ...
    def create_smart_order_step(self, data: dict) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.create_smartorder_step, self.header, data
            )
        else:
            response = self.service.post_call(
                Config.create_smartorder_step, self.header, data
    ...
    def create_smart_order_limit(self, data: dict) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.create_smartorder_limit, self.header, data
            )
        else:
            response = self.service.post_call(
                Config.create_smartorder_limit, self.header, data
    ...
    def create_smart_order_trail(self, data: dict) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.create_smartorder_trail, self.header, data
            )
        else:
            response = self.service.post_call(
                Config.create_smartorder_trail, self.header, data
    ...
    def create_smart_order_sip(self, data: dict) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.create_smartorder_sip, self.header, data
            )
        else:
            response = self.service.post_call(
                Config.create_smartorder_sip, self.header, data
    ...
    def modify_smart_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.patch_async_call(
                Config.modify_smartorder, self.header, data
            )
        else:
            response = self.service.patch_call(
                Config.modify_smartorder, self.header, data
    ...
    def cancel_smart_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.delete_async_call(
                Config.cancel_smartorder, self.header, data
            )
        else:
            response = self.service.delete_call(
                Config.cancel_smartorder, self.header, data
    ...
    def pause_smart_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.patch_async_call(
                Config.pause_smartorder, self.header, data
            )
        else:
            response = self.service.patch_call(
                Config.pause_smartorder, self.header, data
    ...
    def resume_smart_order(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.patch_async_call(
                Config.resume_smartorder, self.header, data
            )
        else:
            response = self.service.patch_call(
                Config.resume_smartorder, self.header, data
    ...
    def smart_orderbook_with_filter(self, data=None) -> dict:
        ...
        if self.is_async:
            response = self.service.get_async_call(
                Config.smartorder_orderbook, self.header, data
            )
        else:
            response = self.service.get_call(
                Config.smartorder_orderbook, self.header, data
    ...
    def create_smartexit_trigger(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.smartexit_trigger, self.header, data
            )
        else:
            response = self.service.post_call(
                Config.smartexit_trigger, self.header, data
    ...
    def update_smartexit_trigger(self, data) -> dict:
        ...
        if self.is_async:
            ...
            response = self.service.put_call(
                Config.smartexit_trigger, self.header, data
            )
        return response
    ...
    def activate_deactivate_smartexit_trigger(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.post_async_call(
                Config.activate_smartexit_trigger, self.header, data
            )
        else:
            response = self.service.post_call(
                Config.activate_smartexit_trigger, self.header, data
    ...
    def orderhistory(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.get_async_call(
                Config.orderhistory, self.header, data
            )
        else:
    ...
    def tradehistory(self, data) -> dict:
        ...
        if self.is_async:
            response = self.service.get_async_call(
                Config.tradeHistory, self.header, data
            )
        else:

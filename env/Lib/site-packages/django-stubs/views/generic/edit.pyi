...
class ModelFormMixin(
    FormMixin[_ModelFormT], SingleObjectMixin[_M], Generic[_M, _ModelFormT]
):
...
class BaseDeleteView(
    DeletionMixin[_M], FormMixin[_FormT], BaseDetailView[_M], Generic[_M, _FormT]
):
    object: _M

class DeleteView(
    SingleObjectTemplateResponseMixin, BaseDeleteView[_M, _FormT], Generic[_M, _FormT]
):
    object: _M
    template_name_suffix: str

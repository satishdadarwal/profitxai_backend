...
_DatedItems: TypeAlias = tuple[
    _IndexableCollection[datetime.date] | None, _IndexableCollection[_M], dict[str, Any]
]
...
class BaseDateDetailView(
    YearMixin, MonthMixin, DayMixin, DateMixin, BaseDetailView[_M]
):
    @override

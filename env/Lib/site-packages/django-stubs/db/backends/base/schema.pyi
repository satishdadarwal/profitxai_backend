...
class BaseDatabaseSchemaEditor(AbstractContextManager[Any]):
    ...
    def execute(
        self, sql: Statement | str, params: Sequence[Any] | None = ()
    ) -> None: ...
    ...
    def add_constraint(
        self, model: type[Model], constraint: BaseConstraint
    ) -> None: ...
    ...
    def alter_db_tablespace(
        self, model: type[Model], old_db_tablespace: str, new_db_tablespace: str
    ) -> None: ...

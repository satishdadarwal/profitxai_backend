...
class BaseDatabaseOperations:
    ...
    def date_extract_sql(
        self, lookup_type: str, sql: Any, params: Any
    ) -> tuple[str, Any]: ...
    # def date_interval_sql(self, timedelta: None) -> Any: ...
    def date_trunc_sql(
        self, lookup_type: str, sql: str, params: Any, tzname: str | None = None
    ) -> tuple[str, Any]: ...
    def datetime_cast_date_sql(
        self, sql: str, params: Any, tzname: str | None
    ) -> tuple[str, Any]: ...
    def datetime_cast_time_sql(
        self, sql: str, params: Any, tzname: str | None
    ) -> tuple[str, Any]: ...
    def datetime_extract_sql(
        self, lookup_type: str, sql: str, params: Any, tzname: str | None
    ) -> tuple[str, Any]: ...
    ...
    def bulk_insert_sql(
        self, fields: Iterable[Field], placeholder_rows: Iterable[str]
    ) -> str: ...
    ...
    def lookup_cast(
        self, lookup_type: str, internal_type: str | None = None
    ) -> str: ...
    ...
    def returning_columns(self, fields: Iterable[Field]) -> tuple[str, tuple[()]]: ...
    def fetch_returned_rows(
        self, cursor: CursorWrapper, returning_params: tuple[()]
    ) -> list[tuple[Any, ...]]: ...
    ...
    def sequence_reset_by_name_sql(
        self, style: Style | None, sequences: list[Any]
    ) -> list[Any]: ...
    ...
    def adapt_timefield_value(
        self, value: real_datetime | time | None
    ) -> str | None: ...
    ...
    def subtract_temporals(
        self, internal_type: Any, lhs: Any, rhs: Any
    ) -> tuple[str, tuple[Any, ...]]: ...
    ...
    def explain_query_prefix(
        self, format: str | None = None, **options: Any
    ) -> str: ...
    ...
    def compile_json_path(
        self, key_transforms: Iterable[str], include_root: bool = True
    ) -> str: ...

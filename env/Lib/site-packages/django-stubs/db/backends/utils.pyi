...
class CursorWrapper:
    ...
    def callproc(
        ...
        kparams: dict[str, int] | None = None,
    ) -> Any: ...
    def execute(
        self, sql: _ExecuteQuery, params: _ExecuteParameters | None = None
    ) -> Any: ...
    def executemany(
        self, sql: _ExecuteQuery, param_list: Sequence[_ExecuteParameters]
    ) -> Any: ...
...
def truncate_name(
    identifier: str, length: int | None = None, hash_len: int = 4
) -> str: ...

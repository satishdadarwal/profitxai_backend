...
_ExprListCompatible: TypeAlias = (
    Sequence[BaseExpression | F | str] | BaseExpression | F | str
)
...
class Combinable:
    ...
    def __add__(
        self, other: datetime.timedelta | Combinable | _Numeric | str | None
    ) -> CombinedExpression: ...
    def __sub__(
        self, other: datetime.timedelta | Combinable | _Numeric
    ) -> CombinedExpression: ...
    def __mul__(
        self, other: datetime.timedelta | Combinable | _Numeric
    ) -> CombinedExpression: ...
    ...
    def __radd__(
        self, other: datetime.datetime | _Numeric | Combinable | None
    ) -> CombinedExpression: ...
...
class BaseExpression:
    ...
    def set_source_expressions(
        self, exprs: Sequence[Combinable | Expression]
    ) -> None: ...
    def as_sql(
    ...
    def select_format(
        self, compiler: SQLCompiler, sql: str, params: _ParamsT
    ) -> _AsSqlType: ...
...
class Func(SQLiteNumericMixin, Expression, Generic[_OutputField]):
    ...
    extra: dict[Any, Any]
    def __init__(
        self, *expressions: Any, output_field: _OutputField | None = None, **extra: Any
    ) -> None: ...
    @override
    def as_sql(
        self,
...
class DatabaseDefault(Expression):
    def __init__(
        self, expression: Expression, output_field: Field | None = None
    ) -> None: ...
...
class Col(Expression):
    ...
    def __init__(
        self, alias: str, target: Field, output_field: Field | None = None
    ) -> None: ...
    @override
    def relabeled_clone(self, relabels: Mapping[str, str]) -> Self: ...
...
class ExpressionList(Func):
    def __init__(
        self,
        *expressions: BaseExpression | Combinable,
        output_field: Field | None = None,
        **extra: Any,
    ) -> None: ...
...
class OrderByList(ExpressionList):
    @classmethod
    def from_param(
        cls, context: str, param: _ExprListCompatible | None
    ) -> Self | None: ...
...
class When(Expression):
    ...
    result: Any
    def __init__(
        self, condition: Any | None = None, then: Any | None = None, **lookups: Any
    ) -> None: ...
    @override
    def as_sql(
        self,
...
class Subquery(BaseExpression, Combinable, Generic[_OutputField]):
    ...
    def __init__(
        self,
        queryset: Query | QuerySet | Subquery,
...
class Exists(Subquery):
    ...
    def __init__(
        self, queryset: Query | QuerySet | Subquery, **kwargs: Any
    ) -> None: ...

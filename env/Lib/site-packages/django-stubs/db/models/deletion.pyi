...
class Collector:
    ...
    def __init__(
        self, using: str, origin: Model | QuerySet[Model] | None = None
    ) -> None: ...
    def add(
        self,
    ...
    def add_field_update(
        self, field: Field, value: Any, objs: _IndexableCollection[Model]
    ) -> None: ...
    def add_restricted_objects(
        self, field: Field, objs: _IndexableCollection[Model]
    ) -> None: ...
    def clear_restricted_objects_from_set(
        self, model: type[Model], objs: set[Model]
    ) -> None: ...
    def clear_restricted_objects_from_queryset(
        self, model: type[Model], qs: QuerySet[Model]
    ) -> None: ...
    def can_fast_delete(
        self, objs: Model | Iterable[Model], from_field: Field | None = None
    ) -> bool: ...
    def get_del_batches(

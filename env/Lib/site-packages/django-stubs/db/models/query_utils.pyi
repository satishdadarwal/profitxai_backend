...
class class_or_instance_method:
    ...
    def __init__(
        self, class_method: Callable[..., Any], instance_method: Callable[..., Any]
    ) -> None: ...
...
class Q(tree.Node):
    ...
    def replace_expressions(
        self, replacements: dict[tree.Node, tree.Node]
    ) -> tree.Node: ...
...
class RegisterLookupMixin:
    ...
    def register_class_lookup(
        cls, lookup: _R, lookup_name: str | None = None
    ) -> _R: ...
    def register_instance_lookup(
        self, lookup: _R, lookup_name: str | None = None
    ) -> _R: ...
    @classmethod
    def register_lookup(cls, lookup: _R, lookup_name: str | None = None) -> _R: ...
    @classmethod
    def _unregister_class_lookup(
        cls, lookup: type[Lookup], lookup_name: str | None = None
    ) -> None: ...
    def _unregister_instance_lookup(
        self, lookup: type[Lookup], lookup_name: str | None = None
    ) -> None: ...
    @classmethod
...
class FilteredRelation:
    ...
    def resolve_expression(
        self, query: Query, reuse: set[str], *args: Any, **kwargs: Any
    ) -> FilteredRelation: ...
    def as_sql(

...
_PrefetchedQuerySetT = TypeVar(
    "_PrefetchedQuerySetT",
    bound=QuerySet[Model],
    covariant=True,
...
class QuerySet(
    AltersData, _SupportsContains[object], Iterable[_Row], Sized, Generic[_Model, _Row]
):
    model: type[_Model]
    query: Query
    ...
    def in_bulk(
        self, id_list: Iterable[Any] | None = None, *, field_name: str = "pk"
    ) -> dict[Any, _Model]: ...
    async def ain_bulk(
        self, id_list: Iterable[Any] | None = None, *, field_name: str = "pk"
    ) -> dict[Any, _Model]: ...
    ...
    def prefetch_related(
        self, *lookups: str | Prefetch[_LookupT, _PrefetchedQuerySetT, _ToAttrT]
    ) -> Self: ...
...
class Prefetch(Generic[_LookupT, _PrefetchedQuerySetT, _ToAttrT]):
    ...
    def __init__(
        self,
        lookup: _LookupT,
        queryset: _PrefetchedQuerySetT | None = None,
        to_attr: _ToAttrT | None = None,
    ) -> None: ...
    if sys.version_info >= (3, 11):
        @override
        def __getstate__(self) -> dict[str, Any]: ...
    ...
    def get_current_querysets(
        self, level: int
    ) -> list[_PrefetchedQuerySetT] | None: ...

def normalize_prefetch_lookups(
    lookups: Sequence[str | Prefetch], prefix: str | None = None
) -> list[Prefetch]: ...
def prefetch_related_objects(
    model_instances: Sequence[_Model], *related_lookups: str | Prefetch
) -> None: ...
...
def get_related_populators(
    klass_info: dict[str, Any], select: Any, db: str

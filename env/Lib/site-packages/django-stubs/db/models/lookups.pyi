...
class Lookup(Expression, Generic[_T]):
    ...
    def batch_process_rhs(
        ...
        rhs: OrderedSet | None = None,
    ) -> tuple[list[str], list[str]]: ...
    @override
    def get_source_expressions(self) -> list[Expression]: ...
    @override
    def set_source_expressions(
        self, new_exprs: Sequence[Combinable | Expression]
    ) -> None: ...
...
class IntegerGreaterThanOrEqual(
    IntegerFieldOverflow, IntegerFieldFloatRounding, GreaterThanOrEqual[int | float]
): ...
class IntegerLessThan(
    IntegerFieldOverflow, IntegerFieldFloatRounding, LessThan[int | float]
): ...

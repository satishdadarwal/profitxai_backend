...
class ModelStateFieldsCacheDescriptor:
    ...
    @overload
    def __get__(
        self, instance: ModelState, cls: type[ModelState] | None = None
    ) -> dict[Any, Any]: ...
...
class Model(AltersData, metaclass=ModelBase):
    ...
    def date_error_message(
        self, lookup_type: str, field_name: str, unique_for: str
    ) -> ValidationError: ...
    def unique_error_message(
        self, model_class: type[Model], unique_check: Sequence[str]
    ) -> ValidationError: ...

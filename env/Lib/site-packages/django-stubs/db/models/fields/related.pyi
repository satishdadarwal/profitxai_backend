...
def resolve_relation(
    scope_model: type[Model], relation: str | type[Model]
) -> str | type[Model]: ...
def lazy_related_operation(
    function: Callable[..., Any],
    model: type[Model],
    *related_models: type[Model] | str,
    **kwargs: Any,
) -> None: ...
...
class RelatedField(FieldCacheMixin, Field[_ST, _GT]):
    ...
    def contribute_to_class(
        self, cls: type[Model], name: str, private_only: bool = False, **kwargs: Any
    ) -> None: ...
...
class ForeignObject(RelatedField[_ST, _GT]):
    ...
    to_fields: Sequence[
        str | None
    ]  # None occurs in ForeignKey, where to_field defaults to None
    def __init__(
        self,
        to: type[Model] | str,
    ...
    ) -> ForwardManyToOneDescriptor[Self]: ...
    ...
    def get_instance_value_for_fields(
        instance: Model, fields: Sequence[Field]
    ) -> tuple[Any, ...]: ...
    ...
    def get_extra_restriction(
        self, alias: str, related_alias: str
    ) -> WhereNode | None: ...
    def get_path_info(
        self, filtered_relation: FilteredRelation | None = None
    ) -> list[PathInfo]: ...
    @cached_property
...
class OneToOneField(ForeignKey[_ST, _GT]):
    ...
    def __get__(
        self, instance: None, owner: Any
    ) -> ForwardOneToOneDescriptor[Self]: ...
    # Model instance access
    @overload
    @override
    def __get__(self, instance: Model, owner: Any) -> _GT: ...
...
class ManyToManyField(RelatedField[Any, Any], Generic[_To, _Through]):
    ...
    def __get__(
        self, instance: None, owner: Any
    ) -> ManyToManyDescriptor[_To, _Through]: ...
    # Model instance access
    @overload
    @override
    def __get__(
        self, instance: Model, owner: Any
    ) -> ManyRelatedManager[_To, _Through]: ...
    # non-Model instances
    @overload
    @override
    def __get__(self, instance: Any, owner: Any) -> Self: ...
...
def create_many_to_many_intermediary_model(
    field: ManyToManyField, klass: type[Model]
) -> type[Model]: ...

...
_AllLimitChoicesTo: TypeAlias = (
    _LimitChoicesTo | _LimitChoicesToCallable | _ChoicesCallable
)  # noqa: PYI047
...
class Field(RegisterLookupMixin, Generic[_ST, _GT]):
    ...
    def slice_expression(
        self, expression: Expression, start: int, length: int | None
    ) -> Func: ...
...
class PositiveSmallIntegerField(
    PositiveIntegerRelDbTypeMixin, SmallIntegerField[_ST, _GT]
):

...
class ReverseOneToOneDescriptor(Generic[_From, _To]):
    ...
    def get_prefetch_querysets(
        ...
        QuerySet[_To], Callable[..., Any], Callable[..., Any], bool, str, bool
    ]: ...
    @overload
    def __get__(
        self, instance: None, cls: Any | None = None
    ) -> ReverseOneToOneDescriptor[_From, _To]: ...
    @overload
...
class ReverseManyToOneDescriptor(Generic[_To]):
    ...
    @overload
    def __get__(
        self, instance: Model, cls: Any | None = None
    ) -> RelatedManager[_To]: ...

...
class UpdateQuery(Query):
    ...
    def add_update_fields(
        self, values_seq: list[tuple[Field, type[Model] | None, Case]]
    ) -> None: ...
    def add_related_update(
        self, model: type[Model], field: Field, value: int | str
    ) -> None: ...
...
class InsertQuery(Query):
    ...
    def insert_values(
        self, fields: Iterable[Field], objs: list[Model], raw: bool = False
    ) -> None: ...

...
class SQLCompiler:
    ...
    def get_select(
        ...
        list[tuple[Expression, _AsSqlType, str | None]],
        dict[str, Any] | None,
        dict[str, int],
    ]: ...
    ...
    def apply_converters(
        ...
        list[None | date | datetime | float | Decimal | UUID | bytes | str]
    ]: ...
    ...
    def execute_sql(
        self,
        result_type: Literal["cursor"] = "cursor",
        chunked_fetch: bool = False,
        chunk_size: int = 100,
    ) -> CursorWrapper: ...
    @overload
    ...
    def execute_sql(
        self,
        result_type: Literal["single"] = "single",
        chunked_fetch: bool = False,
        chunk_size: int = 100,
    ...
    def execute_sql(
        self,
        result_type: Literal["multi"] = "multi",
        chunked_fetch: bool = False,
        chunk_size: int = 100,
...
class SQLInsertCompiler(SQLCompiler):
    ...
    def assemble_as_sql(
        self, fields: Any, value_rows: Any
...
class SQLUpdateCompiler(SQLCompiler):
    ...
    def execute_returning_sql(
        self, returning_fields: Sequence[Any] | None
    ) -> list[Sequence[Any]]: ...
    @override

...
class Query(BaseExpression):
    ...
    def add_annotation(
        self, annotation: Any, alias: str, select: bool = True
    ) -> None: ...
    ...
    def join_parent_model(
        self, opts: Any, model: Any | None, alias: str, seen: dict[Any, str]
    ) -> str: ...
    def names_to_path(
        self,
        names: Sequence[str],
    ...
    def table_alias(
        ...
        table_name: str,
        create: bool = False,
        filtered_relation: Any | None = None,
    ) -> tuple[str, bool]: ...
    def get_aggregation(
        self, using: Any, aggregate_exprs: dict[str, Any]
    ) -> dict[str, Any]: ...
    def build_filter(
        self,
    ...
    def add_filter(
        self, filter_lhs: tuple[str, Any], filter_rhs: tuple[str, Any]
    ) -> None: ...
    def add_q(self, q_object: Q, reuse_all: bool = False) -> None: ...
    def build_where(
        self, filter_expr: Q | Expression | dict[str, str] | tuple[str, Any]
    ) -> WhereNode: ...
    ...
    def add_fields(
        self, field_names: Iterable[str], allow_m2m: bool = True
    ) -> None: ...
    def add_ordering(self, *ordering: _OrderByFieldName) -> None: ...
    def clear_where(self) -> None: ...
    def clear_ordering(
        self, force: bool = False, clear_default: bool = True
    ) -> None: ...
    ...
    def build_lookup(
        self, lookups: Sequence[str], lhs: Expression | Query, rhs: Any
    ) -> Lookup: ...
    def try_transform(
        self, lhs: Expression | Query, name: str, lookups: Sequence[str] | None = ...
    ) -> Transform: ...
    def join(
        self,
        join: BaseTable | Join,

...
class BaseManager(Generic[_T]):
    ...
    def deconstruct(
        ...
        bool, str | None, str | None, Sequence[Any] | None, dict[str, Any] | None
    ]: ...
    ...
    def db_manager(
        self, using: str | None = None, hints: dict[str, Model] | None = None
    ) -> Self: ...
    @property
    def db(self) -> str: ...
...
class Manager(BaseManager[_T]):
    ...
    def bulk_update(
        self, objs: Iterable[_T], fields: Iterable[str], batch_size: int | None = ...
    ) -> int: ...
    ...
    def in_bulk(
        self, id_list: Iterable[Any] | None = ..., *, field_name: str = ...
    ) -> dict[Any, _T]: ...
    async def ain_bulk(
        self, id_list: Iterable[Any] | None = ..., *, field_name: str = ...
    ) -> dict[Any, _T]: ...
    ...
    def union(
        self, *other_qs: QuerySet[Model, Any], all: bool = ...
    ) -> QuerySet[_T]: ...
...
class ManagerDescriptor:
    ...
    @overload
    def __get__(
        self, instance: None, cls: type[Model] | None = None
    ) -> BaseManager: ...
    @overload

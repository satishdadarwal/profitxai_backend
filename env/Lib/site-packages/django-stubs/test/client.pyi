...
def closing_iterator_wrapper(
    iterable: Iterable[_T], close: Callable[[], Any]
) -> Iterator[_T]: ...
async def aclosing_iterator_wrapper(
    iterable: AsyncIterable[_T], close: Callable[[], Any]
) -> AsyncIterator[_T]: ...
...
class AsyncClient(
    ClientMixin, _AsyncRequestFactory[Awaitable[_MonkeyPatchedASGIResponse]]
):

...
class RemoteTestRunner:
    ...
    buffer: bool
    def __init__(
        self, failfast: bool = ..., resultclass: Any | None = ..., buffer: bool = ...
    ) -> None: ...
...
class ParallelTestSuite(TestSuite):
    ...
    def handle_event(
        self, result: Any, tests: list[TestSuite], event: Sequence[Any]
    ) -> None: ...
...
class DiscoverRunner:
    ...
    def load_tests_for_label(
        self, label: str, discover_kwargs: dict[str, str]
    ) -> TestSuite: ...
    def build_suite(
        self, test_labels: Sequence[str] | None = ..., **kwargs: Any
    ) -> TestSuite: ...
    def setup_databases(
        self, **kwargs: Any
...
def shuffle_tests(
    tests: Iterable[TestCase], shuffler: Shuffler
) -> Iterator[TestCase]: ...
...
def filter_tests_by_tags(
    tests: Iterable[TestCase], tags: set[str], exclude_tags: set[str]
) -> Iterator[TestCase]: ...

...
class _AssertNumQueriesContext(CaptureQueriesContext):
    ...
    num: int
    def __init__(
        self, test_case: Any, num: Any, connection: BaseDatabaseWrapper
    ) -> None: ...
...
class SimpleTestCase(unittest.TestCase):
    ...
    def assertHTMLEqual(
        self, html1: str, html2: str, msg: str | None = None
    ) -> None: ...
    def assertHTMLNotEqual(
        self, html1: str, html2: str, msg: str | None = None
    ) -> None: ...
    def assertInHTML(
        self, needle: str, haystack: str, count: int | None = None, msg_prefix: str = ""
    ) -> None: ...
    def assertNotInHTML(
        self, needle: str, haystack: str, msg_prefix: str = ""
    ) -> None: ...
    def assertJSONEqual(
        self,
    ...
    def assertXMLNotEqual(
        self, xml1: str, xml2: str, msg: str | None = None
    ) -> None: ...
...
class TransactionTestCase(SimpleTestCase):
    ...
    def assertNumQueries(
        self, num: int, func: None = None, *, using: str = ...
...
class CheckCondition:
    ...
    def __get__(
        self, instance: None, cls: type[TransactionTestCase] | None = ...
    ) -> bool: ...

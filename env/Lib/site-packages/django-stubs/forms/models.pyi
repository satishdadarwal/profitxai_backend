...
def model_to_dict(
    instance: Model, fields: _Fields | None = None, exclude: _Fields | None = None
) -> dict[str, Any]: ...
...
class BaseModelFormSet(BaseFormSet[_ModelFormT], AltersData, Generic[_M, _ModelFormT]):
    ...
    def get_date_error_message(
        self, date_check: tuple[str, Literal["date", "year", "month"], str, str]
    ) -> str: ...
...
class BaseInlineFormSet(
    BaseModelFormSet[_M, _ModelFormT], Generic[_M, _ParentM, _ModelFormT]
):
    instance: _ParentM
    save_as_new: bool
    unique_fields: Collection[str]
...
class ModelChoiceField(ChoiceField, Generic[_M]):
    ...
    @override
    def has_changed(
        self, initial: Model | int | str | UUID | None, data: int | str | None
    ) -> bool: ...
...
class ModelMultipleChoiceField(ModelChoiceField[_M]):
    ...
    def __init__(
        self, queryset: Manager[_M] | QuerySet[_M] | None, **kwargs: Any
    ) -> None: ...
    @override

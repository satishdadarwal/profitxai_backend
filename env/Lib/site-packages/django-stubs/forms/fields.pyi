...
class DateField(BaseTemporalField):
    ...
    @override
    def to_python(
        self, value: None | str | datetime.datetime | datetime.date
    ) -> datetime.date | None: ...
    @override
...
class MultipleChoiceField(ChoiceField):
    ...
    @override
    def has_changed(
        self, initial: Collection[Any] | None, data: Collection[Any] | None
    ) -> bool: ...
...
class SplitDateTimeField(MultiValueField):
    ...
    @override
    def compress(
        self, data_list: tuple[datetime.date, datetime.time] | None
    ) -> datetime.datetime | None: ...
...
class JSONField(CharField):
    ...
    decoder: Any
    def __init__(
        self, encoder: Any | None = None, decoder: Any | None = None, **kwargs: Any
    ) -> None: ...
    @override

...
class Widget(metaclass=MediaDefiningClass):
    ...
    def subwidgets(
        self, name: str, value: Any, attrs: _OptAttrs | None = None
    ...
    def build_attrs(
        self, base_attrs: _OptAttrs, extra_attrs: _OptAttrs | None = None
    ) -> dict[str, Any]: ...
...
class PasswordInput(Input):
    ...
    template_name: str
    def __init__(
        self, attrs: _OptAttrs | None = None, render_value: bool = False
    ) -> None: ...
    @override
    def get_context(
        self, name: str, value: Any, attrs: _OptAttrs | None
...
class DateTimeBaseInput(TextInput):
    ...
    supports_microseconds: bool
    def __init__(
        self, attrs: _OptAttrs | None = None, format: str | None = None
    ) -> None: ...
    @override
    def format_value(self, value: Any) -> str | None: ...
...
class CheckboxInput(Input):
    ...
    template_name: str
    def __init__(
        self, attrs: _OptAttrs | None = None, check_test: _CheckCallable | None = None
    ) -> None: ...
    @override
    def format_value(self, value: Any) -> str | None: ...
    @override
...
class ChoiceWidget(Widget):
    ...
    choices: _Choices
    def __init__(
        self, attrs: _OptAttrs | None = None, choices: _Choices = ()
    ) -> None: ...
    @override
    def subwidgets(
        self, name: str, value: Any, attrs: _OptAttrs | None = None

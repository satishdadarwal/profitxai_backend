...
class LocaleRegexDescriptor:
    @overload
    def __get__(
        self, instance: None, cls: type[_Pattern] | None = None
    ) -> LocaleRegexDescriptor: ...
    @overload
    def __get__(
        self, instance: _Pattern, cls: type[_Pattern] | None = None
    ) -> Pattern[str]: ...
...
class RegexPattern(CheckURLMixin):
    ...
    def __init__(
        self, regex: str, name: str | None = None, is_endpoint: bool = False
    ) -> None: ...
    def match(
        self, path: str
...
class LocaleRegexRouteDescriptor:
    def __get__(
        self, instance: RoutePattern | None, cls: type | None = None
    ) -> Pattern[str]: ...

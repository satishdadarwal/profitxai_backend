...
class TruncateHTMLParser(HTMLParser):
    ...
    def __init__(
        self, *, length: int, replacement: str | None, convert_charrefs: bool = True
    ) -> None: ...
    @cached_property
...
class Truncator(SimpleLazyObject):
    ...
    def chars(
        self, num: int, truncate: str | None = None, html: bool = False
    ) -> str: ...
    def words(
        self, num: int, truncate: str | None = None, html: bool = False
    ) -> str: ...
...
@overload
def get_text_list(
    list_: list[_StrOrPromise], last_word: _StrOrPromise = ...
) -> _StrOrPromise: ...
...
def format_lazy(
    format_string: _StrOrPromise, *args: Any, **kwargs: Any
) -> _StrPromise: ...

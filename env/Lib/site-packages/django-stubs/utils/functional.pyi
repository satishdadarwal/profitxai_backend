...
def keep_lazy(*resultclasses: Any) -> Callable[[_C], _C]: ...
def keep_lazy_text(func: _C) -> _C: ...
...
class LazyObject(Generic[_T]):
    ...
    def __copy__(self) -> Self | _T: ...
    def __deepcopy__(self, memo: dict[int, Any]) -> Self | _T: ...
...
class SimpleLazyObject(LazyObject[_T]):
...
def partition(
    predicate: Callable[[_PartitionMember], int | bool],
    values: Iterable[_PartitionMember],

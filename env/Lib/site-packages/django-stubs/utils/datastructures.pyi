...
class MultiValueDict(dict[_K, _V]):
    ...
    @override
    def setdefault(
        self: MultiValueDict[_K, _V | None], key: _K, default: None = None
    ) -> _V | None: ...
    @overload
    def setdefault(self, key: _K, default: _V) -> _V: ...
    def setlistdefault(
        self, key: _K, default_list: list[_V] | None = None
    ) -> list[_V]: ...
...
class DictWrapper(dict[str, _V]):
    ...
    @overload
    def __init__(
        self, data: Mapping[str, _V], func: _ItemCallable[_V], prefix: str
    ) -> None: ...
    @overload
    def __init__(
        self, data: Iterable[tuple[str, _V]], func: _ItemCallable[_V], prefix: str
    ) -> None: ...
    @override
...
class DeferredSubDict(Generic[_K, _V]):
    ...
    deferred_key: Any
    def __init__(
        self, parent_dict: dict[Any, dict[_K, _V]], deferred_key: Any
    ) -> None: ...

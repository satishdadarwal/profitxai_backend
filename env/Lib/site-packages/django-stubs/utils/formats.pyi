...
def iter_format_modules(
    lang: str, format_module_path: list[str] | str | None = None
) -> Iterator[types.ModuleType]: ...
def get_format_modules(lang: str | None = None) -> list[types.ModuleType]: ...
def get_format(
    format_type: str, lang: str | None = None, use_l10n: bool | None = None
) -> Any: ...

get_format_lazy: Any  # Any: lazy wrapper around get_format

def date_format(
    value: date | builtin_datetime | str,
    format: str | None = None,
    use_l10n: bool | None = None,
) -> str: ...
def time_format(
    value: time | builtin_datetime | str,
    format: str | None = None,
    use_l10n: bool | None = None,
) -> str: ...
def number_format(
...
@overload
def localize(
    value: builtin_datetime | date | time | Decimal | float | str,
    use_l10n: bool | None = None,
) -> str: ...
@overload

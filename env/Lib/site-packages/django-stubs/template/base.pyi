...
class Origin:
    ...
    def __init__(
        self,
        name: str,
        template_name: bytes | str | None = None,
...
class Parser:
    ...
    def invalid_block_tag(
        self, token: Token, command: str, parse_until: Iterable[str] | None = None
    ) -> Any: ...
...
def token_kwargs(
    bits: Sequence[str], parser: Parser, support_legacy: bool = False

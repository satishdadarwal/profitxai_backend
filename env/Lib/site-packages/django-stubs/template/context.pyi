...
class BaseContext(Iterable[Any]):
    ...
    def setdefault(
        self, key: _ContextKeys, default: list[Origin] | int | None = None
    ) -> list[Origin] | int | None: ...
    def new(self, values: _ContextValues | None = None) -> Context: ...
    def flatten(
        self,
    ) -> dict[_ContextKeys, dict[_ContextKeys, type[Any] | str] | int | str | None]: ...
...
class RenderContext(BaseContext):
    ...
    template: Template | None
    def push_state(
        self, template: Template, isolated_context: bool = True
...
def make_context(
    context: dict[str, Any] | None, request: HttpRequest | None = None, **kwargs: Any
) -> Context: ...

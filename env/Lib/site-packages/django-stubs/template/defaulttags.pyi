...
class FirstOfNode(Node):
    ...
    asvar: str | None
    def __init__(
        self, variables: list[FilterExpression], asvar: str | None = None
    ) -> None: ...
...
class RegroupNode(Node):
    ...
    def resolve_expression(
        self, obj: dict[str, real_date], context: Context
    ) -> int | str: ...
...
class PartialNode(Node):
    ...
    def __init__(
        self, partial_name: str, partial_mapping: Mapping[str, PartialTemplate]
    ) -> None: ...
...
def querystring(
    context: Context, query_dict: QueryDict | None = None, **kwargs: Any
) -> str: ...

...
class Library:
    ...
    @overload
    def tag(
        self, name: str | None = None, compile_function: None = None
    ) -> Callable[[_C], _C]: ...
    ...
    @overload
    def filter(
        self, name: str | None = None, filter_func: None = None, **flags: Any
    ) -> Callable[[_C], _C]: ...
    def filter_function(self, func: _C, **flags: Any) -> _C: ...
    @overload
    def simple_tag(
        self, func: _C, takes_context: bool | None = None, name: str | None = None
    ) -> _C: ...
    @overload
    def simple_tag(
        self,
...
class TagHelperNode(Node):
    ...
    ) -> tuple[list[int], dict[str, SafeString | int]]: ...

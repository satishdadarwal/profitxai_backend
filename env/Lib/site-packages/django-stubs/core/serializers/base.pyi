...
class DeserializationError(Exception):
    ...
    def WithData(
        ...
        model: str,
        fk: int | str,
        field_value: Sequence[str] | str | None,
...
class Deserializer:
    ...
    def __init__(
        self, stream_or_string: bytes | str | IO[bytes] | IO[str], **options: Any
    ) -> None: ...
...
class DeserializedObject:
    ...
    def save(
        self, save_m2m: bool = True, using: str | None = None, **kwargs: Any
    ) -> None: ...

...
class Command(BaseCommand):
    ...
    def compression_formats(
        self,
    ) -> dict[str | None, tuple[Callable[[str, _ReadBinaryMode], BufferedReader]]]: ...
    def reset_sequences(
        self, connection: BaseDatabaseWrapper, models: set[type[Model]]
    ) -> None: ...
    ...
    def get_targets(
        self, fixture_name: str, ser_fmt: str | None, cmp_fmt: str | None
    ) -> set[str]: ...

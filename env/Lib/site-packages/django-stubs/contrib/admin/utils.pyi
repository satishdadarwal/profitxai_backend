...
def get_last_value_from_parameters(
    parameters: dict[str, list[str] | str], key: str
) -> str | None: ...
@overload
def prepare_lookup_value(
    key: str, value: list[str], separator: str = ...
) -> list[str] | list[bool]: ...
@overload
def prepare_lookup_value(
    key: str, value: str, separator: str = ...
) -> str | bool | list[str]: ...
@overload
def prepare_lookup_value(key: str, value: _T, separator: str = ...) -> _T: ...
def build_q_object_from_lookup_parameters(
    parameters: dict[str, Iterable[object]],
) -> Q: ...
...
def get_deleted_objects(
    objs: Sequence[Model | None] | QuerySet[Model],
    request: HttpRequest,
...
def model_format_dict(
    obj: Model | type[Model] | QuerySet | Options[Model],
) -> _ModelFormatDict: ...
...
def display_for_field(
    value: Any, field: Field, empty_value_display: str, avoid_link: bool = False
) -> str: ...
...
def get_model_from_relation(
    field: Field | reverse_related.ForeignObjectRel,
) -> type[Model]: ...

...
class AdminSeleniumTestCase(SeleniumTestCase, StaticLiveServerTestCase):
    ...
    def wait_for_and_switch_to_popup(
        self, num_windows: int = 2, timeout: int = 10
    ) -> None: ...
    def wait_for(self, css_selector: str, timeout: int = 10) -> None: ...
    def wait_for_text(
        self, css_selector: str, text: str, timeout: int = 10
    ) -> None: ...
    def wait_for_value(
        self, css_selector: str, text: str, timeout: int = 10
    ) -> None: ...
    ...
    def admin_login(
        self, username: str, password: str, login_url: _StrOrPromise = "/admin/"
    ) -> None: ...
    ...
    def assertCountSeleniumElements(
        self, selector: str, count: int, root_element: Any = None
    ) -> None: ...

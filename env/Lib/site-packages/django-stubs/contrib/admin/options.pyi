...
class BaseModelAdmin(Generic[_ModelT], metaclass=MediaDefiningClass):
    ...
    def get_inlines(
        self, request: HttpRequest, obj: _ModelT | None
    ) -> _ListOrTuple[type[InlineModelAdmin]]: ...
...
_ActionCallable: TypeAlias = Callable[
    [_ModelAdmin, HttpRequest, QuerySet[_ModelT]], HttpResponseBase | None
]
...
class ModelAdmin(BaseModelAdmin[_ModelT]):
    ...
    def get_object(
        self, request: HttpRequest, object_id: str, from_field: str | None = ...
    ) -> _ModelT | None: ...
    ...
    def log_addition(
        self, request: HttpRequest, obj: _ModelT, message: Any
    ) -> LogEntry: ...
    def log_change(
        self, request: HttpRequest, obj: _ModelT, message: Any
    ) -> LogEntry: ...
    ...
    ) -> tuple[Callable[..., str], str, str] | None: ...
    ...
    def save_model(
        self, request: HttpRequest, obj: _ModelT, form: Any, change: Any
    ) -> None: ...
    ...
    def get_formset_kwargs(
        ...
        request: HttpRequest,
        obj: _ModelT,
        inline: InlineModelAdmin[Any, _ModelT],
        prefix: str,
    ) -> dict[str, Any]: ...
...
class InlineModelAdmin(
    BaseModelAdmin[_ChildModelT], Generic[_ChildModelT, _ParentModelT]
):
    model: type[_ChildModelT]
    fk_name: str | None
    formset: type[
        BaseInlineFormSet[_ChildModelT, _ParentModelT, forms.ModelForm[_ChildModelT]]
    ]
    extra: int
    min_num: int | None
    max_num: int | None
    ...
    def __init__(
        self, parent_model: type[_ParentModelT], admin_site: AdminSite
    ) -> None: ...
    @property
    @override
    def media(self) -> Media: ...
